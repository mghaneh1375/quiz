    ...
    <center style="margin-top: 130px">
            ...
            <table style="margin-top: 10px">
                ...
                @foreach($compasses as $compass)
                    ...
                    @if(count($status) > 0)
                        @foreach($status as $itr)
                                @if($itr->type && $itr->floor <= $percent[$i] && $percent[$i] <= $itr->ceil
                                    || (!$itr->type && $kindKarname->compassAvg &&
                    ...
                    @endif
                        ...
                        <td><center>{{$compass->name}}</center></td>
        ...
        @if($kindKarname->compassBarChart)
            ...
            <script type="text/javascript">
                ...
                var compasses = {{json_encode($compasses)}};

                for(i = 0; i < compasses.length; i++) {
                    compasses[i] = compasses[i].name;
                }
//
...
//
//                    title: {
//                        text: 'نمودار مقایسه ای حیطه ها'
//                    },
//
//                    xAxis: {
//                        categories: compasses,
//                        title: {
//                            text: 'حیطه های امتحان'
//                        }
//                    },
//                    yAxis: {
