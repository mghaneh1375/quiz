...
@section('reminder')
    ...
    <center style="margin-top: 130px">
        <div class="myRegister">
            <div class="data row">
                <form method="post" action="{{URL('quizStatus')}}">
                    ...
                    @endforeach
                    <button class="MyBtn btn btn-info" style="width: auto" data-toggle="tooltip" title="ایجاد وضعیت جدید" name="addNewStatus">
                ...
                <div class="data row">
                    <form method="post" action="{{URL('quizStatus')}}" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-12">
                            ...
                            <input type="submit" class="MyBtn" style="width: auto" name="doAddStatus" value="تایید">
                        </div>
                    </form>
                </div>
            @endif
